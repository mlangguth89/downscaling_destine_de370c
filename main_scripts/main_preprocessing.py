...
known_methods = {"EURADIM_Forecasts": PreprocessEURADIM}
...
def main():
    ...
    parser.add_argument("--preproc_outdir", "-out_dir", dest="out_dir", type=str, required=True,
    ...
    parser.add_argument("--grid_description_target", "-grid_des_tar", dest="grid_des_tar", type=str, default="../grid_des/",
                        help="Grid description file to define domain of interest (target domain).")
    parser.add_argument("--preprocess_method", "-method", dest="method", type=str, default="EURADIM_Forecasts",
                        help="Preprocessing method to generate dataset for training, validation and testing.")
    parser.add_argument("--downscaling_factor", "-down_fac", dest="downscaling_fac", type=int, default=5, 
